...
public:
    ...
    void setupUi(QWidget *Page_4)
    {
        ...
        sub_label->setGeometry(QRect(50, 40, 681, 71));
...
"color: #000000;"));
        ...
        img_label->setGeometry(QRect(240, 120, 281, 171));
        ...
        previous_pushButton->setGeometry(QRect(20, 270, 227, 61));
