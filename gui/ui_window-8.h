...
public:
    ...
    void setupUi(QWidget *Page_8)
    {
        ...
        main_label->setGeometry(QRect(240, 10, 221, 31));
...
"color: #000000;"));
        ...
        sub_label->setGeometry(QRect(-150, 40, 681, 121));
...
"color: #000000;"));
        ...
        img_label->setGeometry(QRect(260, 140, 281, 171));
        ...
        previous_pushButton->setGeometry(QRect(90, 330, 227, 61));
